...
> Άνοιγμα αυτής της σελίδας στο [https://nksbks.github.io/test1/](https://nksbks.github.io/test1/)
...
* αναζήτηση για **https://github.com/nksbks/test1** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/nksbks/test1/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/nksbks/test1** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/nksbks/test1/raw/master/.github/makecode/blocks.png)
